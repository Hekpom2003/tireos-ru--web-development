        ...
        return (
            <div className="dev-modal">
                ...
                <div className="dev-modal__body">
                    ...
                    <div className="dev-modal__content">
                        ...
                        <form name="" onSubmit={this.onSubmit}>
                            ...
                            <div className="dev-modal__input">
                                <input type="text" id="formPhone" className={isFilled.phone} name="form_text_5" onChange={this.onChangePhone}/>
                            ...
                            <div className="dev-modal__input">
                                <input type="text" id="formEmail" className={isFilled.email} name="form_text_10" onChange={this.onChangeEmail}/>
                                <label htmlFor="formEmail">email</label>
                            </div>

                            <div className="dev-modal__textarea">
                                <textarea type="text" id="formComment" className={isFilled.comment} name="form_textarea_11" onChange={this.onChangeComment}/>
